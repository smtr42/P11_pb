...
def export(request):
    ...
    # favorite_qs_list == [<QuerySet [{'barcode': '3270160202706', 'product_name': 'Aiguillettes de poulet saveur citron surgelées'}]>,
    #                       <QuerySet [{'barcode': '3564700038062', 'product_name': 'Jambon cru recette italienne'}]>,
    #                       <QuerySet [{'barcode': '3292070006571', 'product_name': 'Houmous extra citron confit'}]>,
    #                       <QuerySet [{'barcode': '3017620422003', 'product_name': 'Nutella'}]>]
